...
class Slot4Act : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        time_12_4.setOnClickListener {
            ...
            val url2 = GlobalVar.url_ip + "/slot_select.php?slotnum=41"
            ...
            val sr2= StringRequest(Request.Method.GET,url2, { response ->
                if(response.equals("0"))
                    ...
                    val url3 = GlobalVar.url_ip + "/update_availablity.php?slotnum=41"
                    ...
                    val url = GlobalVar.url_ip + "/spot_update.php?Spot=41&name="+ userLoginInfo.name
                    //   "http://10.10.10.250/slot_select.php?slotnum=1&available=1'"
        ...
        time_4_8.setOnClickListener {
            ...
            val url2 = GlobalVar.url_ip + "/slot_select.php?slotnum=42"
            ...
            val sr2= StringRequest(Request.Method.GET,url2, { response ->
                if(response.equals("0"))
                    ...
                    val url3 = GlobalVar.url_ip + "/update_availablity.php?slotnum=42"
                    //   "http://10.10.10.250/slot_select.php?slotnum=1&available=1'"
                    ...
                    val url = GlobalVar.url_ip + "/spot_update.php?Spot=42&name="+ userLoginInfo.name
                    //   "http://10.10.10.250/slot_select.php?slotnum=1&available=1'"
        ...
        time_8_12.setOnClickListener {
            ...
            val url2 = GlobalVar.url_ip + "/slot_select.php?slotnum=43"
            ...
            val sr2= StringRequest(Request.Method.GET,url2, { response ->
                if(response.equals("0"))
                    ...
                    val url3 = GlobalVar.url_ip + "/update_availablity.php?slotnum=43"
                    //   "http://10.10.10.250/slot_select.php?slotnum=1&available=1'"
                    ...
                    val url = GlobalVar.url_ip + "/spot_update.php?Spot=43&name="+ userLoginInfo.name
                    //   "http://10.10.10.250/slot_select.php?slotnum=1&available=1'"
